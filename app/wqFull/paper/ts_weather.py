...
indS = DF.siteNoLst.index('09171100')
dataPlot = [yW[:, indS, indC], yOut[:, indS, indC],
            d1.Y[:, indS, indC], d2.Y[:, indS, indC]]
cLst = ['blue', 'red', 'grey', 'black']
axplot.plotTS(axes[0], DFN.t, dataPlot, cLst=cLst)

axplot.titleInner(axes[0], DFN.siteNoLst[indS])
indS = DF.siteNoLst.index('06316400')
dataPlot = [yW[:, indS, indC], yOut[:, indS, indC],
            d1.Y[:, indS, indC], d2.Y[:, indS, indC]]
cLst = ['blue', 'red', 'grey', 'black']
axplot.plotTS(axes[1], DFN.t, dataPlot, cLst=cLst)
axplot.titleInner(axes[1], DFN.siteNoLst[indS])
fig.show()
