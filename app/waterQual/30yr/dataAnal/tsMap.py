...
def funcPoint(iP, axP):
    ...
    # periodgram
    freqQ, powerQ, pQ = waterQuality.calPower('00060', dfOD)
    freqC, powerC, pC = waterQuality.calPower(code, dfOD)
    axP1.plot(1/freqQ, powerC, '-*b', label=shortName)
    axP1.plot(1/freqQ, pQ, '-*r', label=shortName)
    axplot.titleInner(axP1, 'Periodograms')
    axP1.legend()
    axP2.plot(1/freqC, powerQ, '-*b', label='streamflow')
    axP2.plot(1/freqC, pC, '-*r', label='streamflow')
    axplot.titleInner(axP2, 'baluev probability')
    axP2.legend()
...
freqQ, powerQ, pQ = waterQuality.calPower('00060', dfO)
