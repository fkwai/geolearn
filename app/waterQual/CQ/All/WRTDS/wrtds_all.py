...
dirRoot = os.path.join(kPath.dirWQ, 'modelStat', 'WRTDS-D', 'All')
...
dictPar = dict()
colLst = ['count', 'pQ', 'pSinT', 'pCosT', 'pYr', 'b']
for code in codeLst:
...
for kk, siteNo in enumerate(siteNoLst):
    ...
    for code in codeLst:
        ...
        if len(yy) > 10:
            ...
            parLst = [len(yy), coef[0], coef[1], coef[2], coef[3], inte]
