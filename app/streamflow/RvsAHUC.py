...
plot.plotMap(deltaNSE, ax=None, lat=gagelat, lon=gagelon, title='Delta NSE'+'-'+datades, shape=None)
gagese = gageframe[gageframe['id'].isin(subset)]
data = gagese.LSTMNSE.values
plot.plotMap(data, ax=None, lat=gagelat, lon=gagelon, title='LSTM'+'-'+'All Dataset', cRange=[0.0, 1.0], shape=None)
data = gagese.NSEDA1.values
plot.plotMap(data, ax=None, lat=gagelat, lon=gagelon, title='DA-1'+'-'+'All Dataset', cRange=[0.0, 1.0], shape=None)
data = gagese.DeltaNSE.values
plot.plotMap(data, ax=None, lat=gagelat, lon=gagelon, title='Delta NSE'+'-'+'All Dataset', shape=None)
# plot regional VS global delta
deltarg = statDictLst[0]['NSE'] - gagese.LSTMNSE.values
plot.plotMap(deltarg, ax=None, lat=gagelat, lon=gagelon, title='Delta NSE (Regional - All)', shape=None)
