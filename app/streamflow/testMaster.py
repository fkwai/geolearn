...
RHO=365
HIDDENSIZE=256
Ttrain=[19850101, 19950101]

# define directory to save results
exp_name='parameter_optim'
exp_disp='change_basinnorm/change_loss/NSElosstest'
...
predLst = list()
for out in outLst:
    df, pred, obs = master.test(out, tRange=tRange, subset=subset, basinnorm=True, epoch=200, reTest=True)
...
#         cLst='kbrmg',
#         markerLst='---',
#         legLst=['USGS', 'LSTM: '+NSE_LSTM, 'DI(1): '+NSE_DA1], title=subtitle[k], linespec=['-',':',':'], ylabel=ylabel)
